...
class NotificationServiceImpl(private val context: Context) : NotificationService {
    ...
    override fun showNotification(title: String, content: String) {
        ...
        val notification = createNotification(context, notificationClickIntent, title, content)
    ...
    private fun createNotification(context: Context, notificationClickIntent: PendingIntent?, title: String, text: String): Notification? {
